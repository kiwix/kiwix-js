...
const config = {
    ...
    plugins: [
        ...
        copy({
            ...
            { src: ['archives', 'backgroundscript.js', 'index.html', 'manifest.json', 'manifest.v2.json', 'manifest.webapp', 'package.json', 'LICENSE-GPLv3.txt', 'CHANGELOG.md', '*.pfx', '*.cjs'], dest: 'dist' }
            ],
            flatten: true
        })
    ]
