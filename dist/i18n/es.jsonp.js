document.localeJson = {
  "es": {
    "translation": {
      ...
      "configure-expert-bypassappcache": "<b>Modo de desarrollador</b> (<i>¡desactiva el uso sin conexión de esta aplicación!</i>)",
      "configure-expert-bypassappcache-tip": "El Modo de desarrollador omite la AppCache de la propia aplicación, para que siempre vea la última versión de su código. ADVERTENCIA: Dejar esto marcado deshabilitará el uso sin conexión de la PWA. El ajuste borrará todas las cachés de la API de Caché, pero se utilizará la caché de activos a menos que también se desactive arriba. Facilita el desarrollo de nuevo código en la PWA.",
