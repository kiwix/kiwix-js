...
document.localeJson = {
  "fr": {
    "translation": {
      ...
      "about-step3": "Étape 3&nbsp;: Glissez-déposez le fichier dans l'application",
      "about-step3-para1": "Vous pouvez glisser-déposer le fichier dans l'application ouverte (si vous avez un fichier découpé en plusieurs parties, assurez-vous de glisser toutes les parties), ou vous pouvez aller dans le menu «&nbsp;Configurer&nbsp;» et sélectionner votre fichier ZIM.",
