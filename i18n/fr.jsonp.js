...
document.localeJson = {
  "fr": {
    "translation": {
      ...
      "configure-static-content": "Seuls les ZIM avec un contenu statique (de type Wiki) sont pris en charge en mode JQuery.<br />",
      ...
      "configure-expert-hideactivecontentwarning-tip": "Un avertissement s'affiche si vous chargez un ZIM qui contient du contenu actif ou dynamique en mode JQuery. Il n'est pas recommandé de désactiver cet avertissement.",
      ...
      "dialog-bypassappcache-conflict-message": "Vous devez désélectionner «&nbsp;Désactiver AppCache&nbsp;» avant de passer en mode JQuery !",
      ...
      "dialog-serviceworker-registration-failure-message": "Le Service Worker n'a pas pu être enregistré correctement. Redémarrage en mode JQuery... Message d'erreur&nbsp;:",
      ...
      "dialog-sourceverification-alert": "Cette archive ZIM provient-elle d'une source fiable&nbsp;? Si ce n'est pas le cas, vous pouvez toujours lire le fichier ZIM en mode sécurisé (également appelé mode JQuery). La fermeture de cette fenêtre ouvre également le fichier en mode sans échec. Cette option peut être désactivée dans Options avancées.",
      "dialog-sourceverification-title": "Alerte sécurité!",
      "dialog-sourceverification-trust-button": "Source de confiance",
      "dialog-sourceverification-safe-mode-button": "Ouvrir en mode sans échec",
      "dialog-unsupported-archivetype-message": "<p>Vous essayez d'ouvrir une archive de type Zimit, ce qui n'est pas pris en charge par votre navigateur en mode ServiceWorker(Local).</p><p>Nous vous avons temporairement basculé en mode JQuery afin que vous puissiez afficher le contenu statique, mais une grande partie du contenu n'est pas fonctionnelle avec cette configuration.</p>",
      ...
      "alert-activecontentwarning-part1": "Ce ZIM n'est pas entièrement pris en charge en mode JQuery.<br />Le contenu peut être disponible en cliquant sur le bouton de recherche ci-dessus (ou en tapant une lettre de l'alphabet), ou bien",
