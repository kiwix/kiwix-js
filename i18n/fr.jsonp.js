document.localeJson = {
  "fr": {
    "translation": {
      ...
      "configure-btn-refresh-tip": "Actualiser la liste des archives du dossier sélectionné",
      ...
      "configure-select-file-first-option": "Sélectionner fichier ou dossier...",
      ...
      "configure-static-content": "Seuls les ZIM avec un contenu statique (de type Wiki) sont pris en charge en mode Restreint.<br />",
      ...
      "configure-display-themeoption-dark-wikimedianative": "Sombre *",
      ...
      "configure-display-themeoption-auto-wikimedianative": "Automatique *",
      ...
      "configure-display-apptheme-mwinvert-description": "* Solution antérieure pour les ZIM de Wikimédia.",
      "configure-display-apptheme-wikimedianative-description": "* Utilise le thème sombre intégré du ZIM (pour les ZIM Wikimédia avec support de thème natif). Revient à l'inversion si non disponible.",
      ...
      "configure-library-connecting": "Connexion à la bibliothèque",
      "configure-library-incompatible": "Navigateur est incompatible avec la bibliothèque principale",
      "configure-library-mirrors": "Miroirs de bibliothèque",
      "configure-library-primary-unreachable": "<p class=\"error-message\">Serveur principal inaccessible.</p><p>",
      "configure-library-trying-alternative": "Tentative de contact avec le serveur de sauvegarde",
      "configure-library-trying-primary": "Tentative de contact avec le serveur de bibliothèque principal",
      ...
      "configure-previews": "<b>Afficher un aperçu des articles <i>Wikipédia / Wikivoyage</i></b> en survolant les liens (<i>fonctionnalité limitée en Mode Restreint</i>)",
      ...
      "configure-compatibility-option-jquery": "<strong>Mode Restreint</strong> (Ne prend pas en charge le contenu dynamique, compatible avec les anciens navigateurs)",
      ...
      "configure-expert-enablecontenttheme": "<strong>Activer l'ajustement intelligent du schéma de couleurs de l'archive si nécessaire</strong> (<i>recommandé</i> : décocher pour afficher uniquement le schéma d'origine du ZIM)",
      "configure-expert-enablecontenttheme-tip": "Lorsque cette option est activée, le contenu ZIM sera automatiquement adapté pour correspondre au thème de votre application (clair/sombre), y compris lors du changement automatique. Lorsque désactivée, le contenu ZIM s'affiche exactement tel qu'archivé, sans détection ni ajustements de schéma de couleurs. L'interface de l'application respectera toujours le thème choisi.",
      ...
      "dialog-bypassappcache-conflict-message": "Vous devez désélectionner «&nbsp;Désactiver AppCache&nbsp;» avant de passer en mode Restreint !",
      ...
      "dialog-messagechannel-unsupported-message": "L'API MessageChannel n'est pas disponible sur votre appareil. Redémarrage en mode Restreint...",
      "dialog-metadata-warning": "Attention&nbsp;: les données ci-dessus peuvent être falsifiées&nbsp;!",
      "dialog-metadata-name": "Nom : ",
      "dialog-metadata-creator": "Créateur : ",
      "dialog-metadata-publisher": "Éditeur : ",
      "dialog-metadata-scraper": "Grattoir : ",
      ...
      "dialog-serviceworker-unsupported-fallback": "Utiliser le mode Restreint",
      ...
      "dialog-sourceverification-alert": "Cette archive ZIM provient-elle d'une source fiable&nbsp;? Si ce n'est pas le cas, vous pouvez toujours lire le fichier ZIM en mode Restreint. La fermeture de cette fenêtre ouvre également le fichier en mode Restreint. Cette option peut être désactivée dans Options avancées.",
      "dialog-sourceverification-title": "Alerte de sécurité!",
      "dialog-sourceverification-trust-button": "Source de confiance",
      "dialog-sourceverification-restricted-mode-button": "Ouvrir en mode Restreint",
      "dialog-unsupported-archivetype-message": "<p>Vous essayez d'ouvrir une archive de type Zimit, ce qui n'est pas pris en charge par votre navigateur en mode ServiceWorker(Local).</p><p>Nous vous avons temporairement basculé en mode Restreint afin que vous puissiez afficher le contenu statique, mais une grande partie du contenu n'est pas fonctionnelle avec cette configuration.</p>",
      ...
      "about-contentinjection-modes": "Modes Restreint et ServiceWorker",
