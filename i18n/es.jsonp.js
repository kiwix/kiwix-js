...
document.localeJson = {
  "es": {
    "translation": {
      ...
      "configure-expert-enable-source-verification-tip": "Si confía en la fuente de todos sus archivos ZIM, puede desactivar esta opción y se utlizará el modo ServiceWorker por defecto (si está disponible).",
      "configure-expert-enable-source-verification-check-box": "<strong>Activar la verificación del origen de los archivos nuevos</strong> (<i>recomendado</i>: Sólo se le pedirá la primera vez que abra una ZIM)",
      ...
      "configure-static-content": "Sólo funcionan bien los ZIM con contenido estático (tipo Wiki) en el modo JQuery.<br />",
      ...
      "configure-performance-settings-title": "Mejorar rendimiento",
      "configure-performance-panel-header": "Acelerar acceso al archivo",
      ...
      "configure-compatibility-settings-title": "Opciones de compatibilidiad",
      ...
      "configure-compatibility-option-serviceworkerlocal": "<strong>ServiceWorkerLocal</strong> (Service Worker local seguro, pero <i>sin ejecución arbitraria de JavaScript</i>)",
      ...
      "configure-compatibility-option-jquery": "<strong>JQuery</strong> (<i>obsoleto</i>: no soporta contenido dinámico, compatible con navegadores antiguos)",
      "configure-compatibility-option-jquery-tip": "Este modo está obsoleto, pero funciona bien con los archivos de Wikipedia / WikiMedia. Funciona en todos los dispositivos.",
      ...
      "configure-expert-hideactivecontentwarning-tip": "Se muestra una advertencia si carga un ZIM que tiene contenido activo o dinámico mientras está en modo JQuery. No se recomienda desactivar esta advertencia.",
      ...
      "dialog-bypassappcache-conflict-message": "¡Debe deseleccionar la opción \"Desactivar AppCache\" antes de cambiar al modo JQuery!",
      ...
      "dialog-serviceworker-registration-failure-message": "El Service Worker no se pudo registrar correctamente. Reactivando el modo JQuery... Mensaje de error:",
      ...
      "dialog-sourceverification-alert": "¿Es este archivo ZIM de una fuente de confianza?\n Si no es así, aún puede leer el archivo ZIM en Modo Seguro (también conocido como modo JQuery). Al cerrar esta ventana también se abre el archivo en Modo Seguro. Esta opción puede desactivarse en Opciones avanzadas.",
      "dialog-sourceverification-title": "¡Alerta de seguridad!",
      "dialog-sourceverification-trust-button": "Fuente de confianza",
      "dialog-sourceverification-safe-mode-button": "Abrir en modo seguro",
      "dialog-unsupported-archivetype-message": "<p>Está intentando abrir un archivo Zimit, lo cual no es compatible con su navegador en modo ServiceWorker(Local).</p><p>Le hemos cambiado temporalmente al modo JQuery para que pueda ver el contenido estático, pero gran parte del contenido no es funcional con esta configuración.</p>",
      ...
      "about-contentinjection-modes": "Modos JQuery y ServiceWorker",
      ...
      "about-zim-format-para2": "Esta aplicación es ahora totalmente compatible con los archivos creados por <b>Zimit</b> (<a href=\"https://youzim.it\" target=\"_blank\">https://youzim.it&nbsp;<img src=\"img/Icon_External_Link.png\" /></a>) utilizando el formato Archivo de Web (WARC), siempre que su navegador soporte el modo ServiceWorker. Si sólo puede utilizar el modo JQuery  (o ServiceWorkerLocal), hacemos todo lo posible para mostrarle el contenido estático del artículo solicitado (no se puede ejecutar JavaScript en este modo). Esto funcionará para algunos sitios estáticos básicos, pero muchos se verán rotos. Busque contenido de la forma habitual.",
      ...
      "alert-activecontentwarning-part1": "Este ZIM no es totalmente compatible con el modo JQuery.<br />El contenido puede estar disponible haciendo clic en el botón de búsqueda arriba (o escribiendo una letra del alfabeto), o bien",
