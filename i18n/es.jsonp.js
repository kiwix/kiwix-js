...
document.localeJson = {
  "es": {
    "translation": {
      ...
      "configure-expert-enable-source-verification-tip": "Advertencia: Algunos archivos ZIM de fuentes no fiables podrían ejecutar código malicioso en tu navegador. Esto puede evitarse utilizando el modo seguro, que no puede ejecutar contenido activo desde el ZIM. Los ZIM muy dinámicos probablemente fallarán en el modo seguro, pero los ZIM con contenido mayoritariamente estático deberían funcionar. Si confía en la fuente de todos sus archivos ZIM, puede desactivar esta opción y se utlizará el modo ServiceWorker por defecto (si está disponible).",
      ...
      "configure-static-content": "Sólo funcionan bien los ZIM con contenido estático (tipo Wiki) en el modo seguro.<br />",
      ...
      "dialog-bypassappcache-conflict-message": "¡Debe deseleccionar la opción \"Desactivar AppCache\" antes de cambiar al modo seguro!",
      ...
      "dialog-sourceverification-alert": "¿Proviene este archivo ZIM de una fuente de confianza?\nDe no ser así, aún puede leer el archivo en Modo Seguro (también conocido como modo seguro). Al cerrar esta ventana también se abre el archivo en Modo Seguro. Esta verificación puede desactivarse en Opciones avanzadas.",
      ...
      "dialog-unsupported-archivetype-message": "<p>Está intentando abrir un archivo Zimit, lo cual no es compatible con su navegador en modo ServiceWorker(Local).</p><p>Le hemos cambiado temporalmente al modo seguro para que pueda ver el contenido estático, pero gran parte del contenido no es funcional con esta configuración.</p>",
      ...
      "about-zim-format-para2": "Esta aplicación es ahora totalmente compatible con los archivos creados por <b>Zimit</b> (<a href=\"https://youzim.it\" target=\"_blank\">https://youzim.it&nbsp;<img src=\"img/Icon_External_Link.png\" /></a>) utilizando el formato Archivo de Web (WARC), siempre que su navegador soporte el modo ServiceWorker. Si sólo puede utilizar el modo seguro  (o ServiceWorkerLocal), hacemos todo lo posible para mostrarle el contenido estático del artículo solicitado (no se puede ejecutar JavaScript en este modo). Esto funcionará para algunos sitios estáticos básicos, pero muchos se verán rotos. Busque contenido de la forma habitual.",
      ...
      "alert-activecontentwarning-part1": "Este ZIM no es totalmente compatible con el modo seguro.<br />El contenido puede estar disponible haciendo clic en el botón de búsqueda arriba (o escribiendo una letra del alfabeto), o bien",
