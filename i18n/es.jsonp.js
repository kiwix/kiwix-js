document.localeJson = {
  "es": {
    "translation": {
      ...
      "home-btn-colourscheme-tip": "Alternar entre temas claro, oscuro y automático",
      ...
      "configure-select-file-first-option": "Elija archivo o carpeta...",
      ...
      "configure-display-themeoption-dark-wikimedianative": "Oscuro *",
      ...
      "configure-display-themeoption-auto-wikimedianative": "Automático *",
      "configure-display-apptheme-auto-description": "&emsp;(Temas automáticos se adaptan al modo oscuro/claro de su dispositivo.)",
      "configure-display-apptheme-mwinvert-description": "* Solución anterior para ZIMs de Wikimedia.",
      "configure-display-apptheme-wikimedianative-description": "* Utiliza el tema oscuro integrado del ZIM (para ZIMs de Wikimedia con soporte de tema nativo). Se revierte a la inversión si no está disponible.",
