document.localeJson = {
  "es": {
    "translation": {
      ...
      "home-btn-colourscheme-tip": "Cambiar entre temas oscuro y claro",
      ...
      "configure-expert-enablecontenttheme": "<strong>Habilitar manipulación de tema de contenido</strong> (desmarcar para mostrar el contenido ZIM sin cambios de tema claro/oscuro)",
      "configure-expert-enablecontenttheme-tip": "Cuando está habilitado, el contenido ZIM se ajustará automáticamente para coincidir con el tema de su aplicación (claro/oscuro). Cuando está deshabilitado, el contenido ZIM se muestra exactamente como fue archivado, sin detección ni ajustes de esquema de color. La interfaz de la aplicación seguirá respetando el tema elegido.",
