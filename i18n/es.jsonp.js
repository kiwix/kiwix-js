...
document.localeJson = {
  "es": {
    "translation": {
      ...
      "configure-compatibility-option-jquery": "<strong>Modo Seguro</strong> (No soporta contenido dinámico, compatible con navegadores antiguos)",
      ...
      "dialog-sourceverification-alert": "¿Proviene este archivo ZIM de una fuente de confianza?\nDe no ser así, aún puede leer el archivo en modo Seguro. Al cerrar esta ventana también se abre el archivo en modo Seguro. Esta verificación puede desactivarse en Opciones avanzadas.",
      ...
      "about-contentinjection-modes": "Modos Seguro y ServiceWorker",
