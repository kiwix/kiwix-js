...
document.localeJson = {
  "en": {
    "translation": {
      ...
      "about-zim-format-para2": "This application is now fully compatible with archives that are created by <b>Zimit</b> (<a href=\"https://youzim.it\" target=\"_blank\">https://youzim.it&nbsp;<img src=\"img/Icon_External_Link.png\" /></a>) using the Web Archive (WARC) format, so long as your browser supports ServiceWorker mode. If you can only use JQuery mode (or ServiceWorkerLocal), we do our best to show you the static content of the requested article (no JavaScript can run in this mode). This will work for some basic static sites, but many will look broken. Search for content in the usual way.",
