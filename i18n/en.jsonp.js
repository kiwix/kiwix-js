document.localeJson = {
  "en": {
    "translation": {
      ...
      "configure-expert-bypassappcache": "<b>Developer Mode</b> (<i>disables offline use of this app!</i>)",
      "configure-expert-bypassappcache-tip": "Developer Mode bypasses the app's own AppCache, so that you always see the latest version of your code. WARNING: Leaving this checked will prevent offline usage of the PWA. Setting will clear all existing Cache API caches, but assetsCache will be used unless also disabled above. For testing new code with the PWA.",
      ...
      "api-serviceworker-available-registering": "ServiceWorker API: available, trying to register it...",
      ...
      "about-step1-para1": "Go to <a href=\"https://library.kiwix.org\" target=\"_blank\">https://library.kiwix.org&nbsp;<img src=\"img/Icon_External_Link.png\" /></a> (easy-to-use graphical interface, archive previews) or <a href=\"https://ftp.fau.de/kiwix/zim/\" target=\"_blank\">https://ftp.fau.de/kiwix/zim/&nbsp;<img src=\"img/Icon_External_Link.png\" /></a> (traditional file list), and select the archives that interest you in your favourite language(s). If you don't have Internet access, you can also access/share content from a USB stick.",
      "about-step1-para2": "For a quick test, we recommend you start with a small archive containing all the <a href=\"https://browse.library.kiwix.org/?q=climate+change\" target=\"_blank\">Wikipedia articles about climate change&nbsp;<img src=\"img/Icon_External_Link.png\" /></a> in English.",
      "about-step1-para3": "Wikipedia archives with \"<b>mini</b>\" in the filename are the smallest, since they only contain the introduction of each article; \"<b>nopic</b>\" means no pictures; \"<b>maxi</b>\" means everything except video and audio. The largest files without any of these qualifiers are complete. Note that you can only see the filenames easily in the <a href=\"https://ftp.fau.de/kiwix/zim/\" target=\"_blank\">traditional file list&nbsp;<img src=\"img/Icon_External_Link.png\" /></a>.",
