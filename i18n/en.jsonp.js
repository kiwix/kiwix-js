document.localeJson = {
  "en": {
    "translation": {
      ...
      "about-search-para2b": "<b>Regex title search:</b> If you type a pattern in the form <code>/pattern/flags</code>, the app searches article titles using a regular expression. This is limited to titles only, so it does not apply to full-text search. For example, <code>/^France/</code> matches titles that start with \"France\". If the regex is invalid, the app falls back to normal title search.",
