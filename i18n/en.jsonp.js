document.localeJson = {
  "en": {
    "translation": {
      ...
      "configure-display-themeoption-dark-wikimedianative": "Dark (Wikimedia native)",
      ...
      "configure-display-themeoption-auto-wikimedianative": "Auto (Wikimedia native)",
      ...
      "configure-display-apptheme-wikimedianative-description": "* Uses the ZIM's built-in dark theme (for newer Wikimedia ZIMs with native theme support). Falls back to Wikimedia invert if not available.",
