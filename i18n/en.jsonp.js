...
document.localeJson = {
  "en": {
    "translation": {
      ...
      "configure-compatibility-option-jquery": "<strong>Safe Mode</strong> (<i>deprecated</i>: no dynamic content, compatible with older browsers)",
      ...
      "dialog-launchpwa-unsupported-message": "<p>Unfortunately, your browser does not appear to support ServiceWorker mode, which is now the default for this app.</p><p>You can continue to use the app in the (now deprecated) Safe mode, but note that this mode only works well with ZIM archives that have static content, such as Wikipedia / Wikimedia ZIMs or Stackexchange.</p><p>If you can, we recommend that you update your browser to a version that supports ServiceWorker mode.</p>",
      ...
      "dialog-serviceworker-unsupported-message": "<p>Unfortunately, your browser does not appear to support ServiceWorker mode, which is now the default for this app.</p><p>You can continue to use the app in the (now deprecated) Safe mode, but note that this mode only works well with ZIM archives that have static content, such as Wikipedia / Wikimedia ZIMs or Stackexchange.</p><p>If you can, we recommend that you update your browser to a version that supports ServiceWorker mode.</p>",
      ...
      "dialog-sourceverification-alert": "Is this ZIM archive from a trusted source?\n If not, you can still read the ZIM file in Safe Mode (aka Safe mode). Closing this window also opens the file in Safe Mode. This option can be disabled in Expert Settings.",
