document.localeJson = {
  "en": {
    "translation": {
      ...
      "configure-expert-enablecontenttheme": "<strong>Enable intelligent adaptation of ZIM colour scheme if needed</strong> (<i>recommended</i>: uncheck to use original ZIM scheme only)",
